...
void MPU6050::setMotionDetectionDuration(uint8_t mDurationL)
{
    writeRegister8(MPU6050_REG_MOT_DURATION, mDurationL);
}
...
void MPU6050::setZeroMotionDetectionDuration(uint8_t mDurationL)
{
    writeRegister8(MPU6050_REG_ZMOT_DURATION, mDurationL);
}
...
void MPU6050::setFreeFallDetectionDuration(uint8_t mDurationL)
{
    writeRegister8(MPU6050_REG_FF_DURATION, mDurationL);
}
